               ...
               <div class="card-body pa-5 pt-2">
                ...
                <div class="mb-6">
                  ...
                  <v-chip :class="['rank-chip-mini font-weight-black', getRankClass(explorer.level)]" size="x-small">
                    {{ explorer.selectedTitle ? explorer.selectedTitle.replace('Título: ', '') : getRankName(explorer.level) }}
                  </v-chip>
                </div>
                ...
                <div class="mb-6">
                  ...
                  <div class="d-flex align-center gap-2">
                    <v-chip :class="['rank-chip-mini font-weight-black', getRankClass(requester.level)]" size="x-small">
                      {{ requester.selectedTitle ? requester.selectedTitle.replace('Título: ', '') : getRankName(requester.level) }}
                    </v-chip>
        ...
        <div class="text-center">
          ...
          <div class="mb-6">
            <v-chip :class="['rank-chip font-weight-black px-6', getRankClass(profileDialog.user?.level)]" size="large">
              {{ profileDialog.user?.selectedTitle ? profileDialog.user?.selectedTitle.replace('Título: ', '') : getRankName(profileDialog.user?.level) }}
            </v-chip>
