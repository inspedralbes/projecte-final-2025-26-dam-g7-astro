export const wordConstructionData = {
    ...
    en: [
        { word: 'SHIP', hint: 'Space vehicle' },
        { word: 'PLANET', hint: 'Orbits around a star' },
        { word: 'GALAXY', hint: 'Immense set of stars' },
        { word: 'ROCKET', hint: 'Jet propulsion' },
        { word: 'MOON', hint: 'Natural satellite' },
        { word: 'ORBIT', hint: 'Path around a body' },
        { word: 'SUN', hint: 'The star of our system' },
        { word: 'MARS', hint: 'The red planet' },
        { word: 'LIGHT', hint: 'Travels very fast through space' },
        { word: 'UFO', hint: 'Unidentified Flying Object' },
        { word: 'HOLE', hint: 'Can be black and swallow everything' },
        { word: 'CODE', hint: 'Instructions for a program' },
        { word: 'DATA', hint: 'Information processed by AI' },
        { word: 'CHIP', hint: 'Silicon brain of a computer' },
        { word: 'WIFI', hint: 'Wireless connection' },
        { word: 'NETWORK', hint: 'Set of connected computers' },
        { word: 'CAT', hint: 'Domestic feline' },
        { word: 'DOG', hint: 'Man\'s best friend' },
        { word: 'FISH', hint: 'Lives under water' },
        { word: 'TREE', hint: 'Large plant with a trunk' },
        { word: 'BED', hint: 'Furniture for sleeping' },
        { word: 'TABLE', hint: 'Furniture for eating or working' },
        { word: 'DOOR', hint: 'Entrance to a room' },
        { word: 'EYE', hint: 'Organ for seeing' },
        { word: 'FOOT', hint: 'Body part for walking' },
        { word: 'HEART', hint: 'Pumps blood' },
        { word: 'APPLE', hint: 'Red or green fruit' },
        { word: 'BREAD', hint: 'Basic flour food' },
        { word: 'HONEY', hint: 'Bees make it' },
        { word: 'YEAR', hint: '365 days' },
        { word: 'DAY', hint: 'Has 24 hours' },
