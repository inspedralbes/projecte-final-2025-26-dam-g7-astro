...
const phrases = [
    ...
    'LA BALENA BALLA SOTA DEL BOT',
    'LA BIODIVERSITAT ABUNDA AL BOSC',
    'EL PETIT PAQUET VA QUEDAR AL PARC',
    'PERQUE EL FORMATGE PESA POC',
    'VULL PA AMB QUINZE COGOMBRES',
    'ELS DRACS BOTEN SOBRE LES PEDRES',
    'TRES TRISTOS TIGRES MENGEN BLAT',
    'LA BRISA FRESCA CREUA LA PRADERIA',
    'LES FLORS CREIXEN AL COSTAT DE LA PLACA',
    'EL DUC VOLA DE NIT FINS A LA MATINADA',
    'LA HERBA HUMIDA FA OLOR DE FERRO',
    ...
    'EL RINOCERONT NECESSITA REFRIGERACIO',
    'INCOMPRENSIBLE PREDICCIO METEOROLOGICA',
    'LA NAU ESPACIAL DESPEGA A LALBA',
