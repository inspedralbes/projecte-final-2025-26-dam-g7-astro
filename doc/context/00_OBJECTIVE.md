...
### 2.1. Estimulació Cognitiva Efectiva
Oferir un catàleg de minijocs que impactin positivament en àrees clau com la memòria, l'atenció, la velocitat de processament i la resolució de problemes.
...
## 3. Públic Objectiu
- **Estudiants i Joves:** Per millorar la concentració i agilitat mental.
- **Adults:** Com a eina de manteniment cognitiu i desconnexió productiva.
- **Entorns Educatius:** On professors poden monitoritzar el progrés de grups d'alumnes (Rol TEACHER/CENTER).

## 4. Diferenciadors Clau
- **Estètica "Space-Neon":** Una interfície visualment impactant que s'allunya de les aplicacions de salut tradicionals.
- **Sistema de Raches en Temps Real:** Un motor de backend que gestiona la constància de l'usuari amb precisió de segons.
- **Arquitectura de Micro-serveis:** Preparada per escalar i afegir nous minijocs de manera modular.
