...
- **Real-Time Engine (WebSockets):** Gestió de l'estat online dels pilots i orquestració de desafiaments multijugador amb la llibreria `ws`.
...
## 3. Administració i Gestió (B2B/Educational)
...
## 4. Fora de l'Abast (Out of Scope)
- **Aplicacions Mòbils Nadiues/Híbrides:** (React Native, Expo, etc.) tota la interacció serà a través de la versió Web responsiva.
